...
public class ProductController {
    ...
    * */
    ...
    public void getProducts2(@RequestParam("proIds") List<String> proIds){
        for (String proId: proIds){
            System.out.println("通过getProducts2获取到了id为"+ proId + "的商品");
        }
    }
    /*
    * 获取单个商品信息
    * */
    ...
    public void getProduct1(@RequestBody Product product){
